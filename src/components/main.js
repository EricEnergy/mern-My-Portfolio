    ...
    render() {
        return (
            <div>
                ...
                <h2 id="name" className="text-center">Welcome! </h2> <h4 className="text-center mb-4"> Full Stack Developers are computer programmers who are proficient in both front and back end coding. Their primary responsibilities include designing user interactions on websites, developing servers and databases for website functionality and coding for mobile platforms</h4>
                <Jumbotron id="jumbotron">
                    ...
                    <Row>
                        <Col md="auto" className="text-center mb-4">
                            ...
                            <p className="ml-4"> <a href={resume}>My Resume</a></p>
                        </Col>
                ...
                <Row>
                    <Col>
                        <h5 className="text-center mt-4 mb-4"> "Eric and I went through the Vanderbilt Coding Boot Camp together, and throughout the program, Eric made great strides as a web developer. He continuously proved that he was willing to put the time and effort required to accomplish whatever goals he set.
                                                            As we worked on a group project together, Eric worked tirelessly to do whatever was necessary to create a viable, functioning application, and was consistently available and engaged to help out wherever he was needed. I believe that Eric's level of motivation and determination would make him an asset to any team." </h5>
                    </Col>
                </Row>
                ...
                <Jumbotron>
                    <Row>
                        <Col></Col>
                        <Col><h4 className=" ml-5 mt-4 mb-4" id="dark">
                            <u>Technologies I've Used</u>
                        </h4></Col>
                        <Col></Col>
